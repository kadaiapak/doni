...
$routes->get('/admin/blog/tambah', 'Admin\Blog::tambah');
$routes->get('/admin/blog/(:any)', 'Admin\Blog::detail/$1');
$routes->post('/admin/blog/simpan', 'Admin\Blog::simpan');
...
$routes->get('/admin/coba', 'Admin\Coba::test');
